        ...
        <main className="main-allProducts">
            ...
            <div className="main-allProducts_categoriesContainer">
                ...
                <div className="main-allProducts_categories">
                    ...
                    {
                        isFilter && <button className="tag tag-Close" onClick={() => {setIsFilter(false); setCurrentCategory('all')}}><i className="fa-solid fa-xmark"></i></button>
                    }
                </div>
            </div>
            <ProductContent parentComponent={'allProducts'} category={currentCategory}/>
        </main>
    );
}
