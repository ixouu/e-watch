  ...
  const addToCart = (e) => {
    ...
    return (
        ...
        <main className="main-product">
                            ...
                            <div className="product-addToCart">
                                <form>
                                    <div className="formQty">
                                        ...
                                        <input type="number" id="product-qty" min="1" max={productData.availableStock}defaultValue="1" onChange={(e) => setValue(Number(e.target.value))}/>
                                    </div>
            ...
            {modalIsOpen && <AddToCartModal open={modalIsOpen} onClose={() => setModalIsOpen(false)} successHandlter={success} productName={productData.title}/>}
        </>
    );
}
