...
const CreditCardFront = ({ paiementInformations }) => {
	...
	return (
		<div className='creditCardFront'>
			...
			<div className='creditCardFront-number'>
				<span ref={numRef}>{creditCardNumber}</span>
			</div>
			<div className='creditCardFront-bottom'>
				<div className='creditCardFront-name'>
					<span ref={nameRef}>{creditCardName}</span>
				</div>
				<div className='creditCardFront-validty'>
					<span ref={monthRef}>{creditCardExpirationMonth}</span>
					<span> / </span>
					<span ref={yearRef}>{creditCardExpriationYear}</span>
				</div>
			</div>
		</div>
	);
